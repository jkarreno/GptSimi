...
{
    $cadena.='<option value="'.$RResSuc["Id"].'">'.$RResSuc["Nombre"].'</option>';
}
$cadena.='          </select>
                </div>
                <div class="c30">
...
for ($semana = $semanaActual; $semana <= $semanasAnio; $semana++) {
    ...
    $cadena.='<option value="' . $semana . '">' . $texto . '</option>';
}
$cadena.='          </select>
                </div>
                <div class="c30">
...
{
    $cadena.='<option value="'.$RResTec["Id"].'">'.$RResTec["Nombre"].'</option>';
}
$cadena.='          </select>
                </div>
                <div class="c100">
                ...
                <div class="c100">
                    ...
                    <input type="submit" name="botadservicio" id="botadservicio" value="Agregar>>" onclick="cerrarmodal()">
                </div>
            </form>
        </div>';
